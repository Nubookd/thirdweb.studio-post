...
export default function Description() {
  ...
  useLayoutEffect(() => {
    ...
    const { setupFirstAnimation, setupSecondAnimation } = animationInfinity(refs);
    ...
    <section className={styles.description}>
      ...
      <div ref={containerRef} className={styles.description__svgContainer}>
        ...
        >
          ...
          <path
            d="M355 177.001C301.122 230.879 233.814 284.717 166.467 284.717C106.98 284.717 58.75 236.488 58.75 177.001C58.75 117.513 106.98 69.2835 166.467 69.2835C233.814 69.2835 301.122 123.122 355 177.001ZM355 177.001C408.878 123.122 476.186 69.2835 543.534 69.2835C603.02 69.2835 651.25 117.513 651.25 177.001C651.25 236.488 603.02 284.717 543.534 284.717C476.186 284.717 408.878 230.879 355 177.001Z"
            stroke="none"
            strokeMiterlimit="10"
            strokeLinecap="square"
          />
          <path
            d="M571.5 177.067C437.857 177.358 363 172.067 268.5 105.067C174 38.067 63.5 69.567 58.5 178.567"
            stroke="none"
          />
          <path
            d="M58.5001 176.717C58.5001 236.204 106.73 284.433 166.217 284.433C233.564 284.433 332.684 208.5 423.184 176.717"
            stroke="none"
            strokeMiterlimit="10"
            strokeLinecap="square"
          />
          ...
          />
          <path
            d="M58.75 177.001C58.75 117.514 106.98 69.2845 166.467 69.2845C233.814 69.2845 301.122 123.122 355 177.001C408.878 230.879 476.186 284.717 543.533 284.717C603.02 284.717 651.25 236.488 651.25 177.001C651.25 117.514 603.02 69.2845 543.533 69.2845C476.186 69.2845 408.878 123.122 355 177.001C301.122 230.879 233.814 284.717 166.467 284.717C106.98 284.717 58.75 236.488 58.75 177.001Z"
            stroke="white"
            strokeWidth="1"
            strokeMiterlimit="10"
            fill="none"
